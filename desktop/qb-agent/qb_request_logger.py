...
Integration in sync service (qb_sdk_service.py):
  In process_request(), before self.qb.ProcessRequest(...):
    from qb_request_logger import log_qb_request
    log_qb_request(qbxml, log_dir=LOG_DIR)  # use your sync service LOG_DIR
  After getting response:
    from qb_request_logger import log_qb_response
    log_qb_response(response, log_dir=LOG_DIR)
  Copy this module (qb_request_logger.py) into the sync service Python folder.
"""
